...
//setcookie("wwww",NULL);
            ...
            if (isset($item['options']) && isset($item['options']['multi-controller']) && $item['options']['multi-controller']) {
                if (is_array($item['options']['multi-controller']) && in_array(Yii::$app->controller->id, $item['options']['multi-controller'])) {
                    return true;
                }
                if (is_string($item['options']['multi-controller']) && Yii::$app->controller->id === $item['options']['multi-controller']) {
                    return true;
                }
            }
            $_route = ltrim($route, '/');
